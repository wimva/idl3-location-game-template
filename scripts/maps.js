function createMap(myID, lat, lng, zoom, styled) {
  ...
  function createMarker(className, myWidth, myHeight, image, lat, lng, draggable) {
  ...
  createMap("map", 51.219608, 4.411694, 10, 'mapbox://styles/matthekim/ckv6gc88y0c9u15t5ppk1horn');
  createMarker('marker',20, 30, "https://driesvannoten-la.com/img/pin.svg",51.219608,4.411694, false);